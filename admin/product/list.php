...
//第一種法子
$sth = $db->query("SELECT * FROM product WHERE categoryID=".$_GET['cateID']." ORDER BY createdDate DESC LIMIT ".$start_from.",".$limit);
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <a class="btn btn-primary my-2" href="../product_category/list.php">返回</a>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          ...
          <table class="table">
            ...
            <?php if ($totalRows > 0) {?>
              ...
              <tr>
                <td><img src="../../uploads/products/<?php echo $row['picture']; ?>" width="200"/></td>
                <td><?php echo $row['name']; ?></td>
                <td><?php echo $row['price']; ?></td>
                <th><a href="edit.php?cateID=<?php echo $row['categoryID'] ?>&&productID=<?php echo $row['productID'];?>" class="btn btn-danger" role="button">編輯</a></th>
                <th><a href="delet.php?cateID=<?php echo $row['categoryID'] ?>&&productID=<?php echo $row['productID'];?>" class="btn btn-danger" role="button" onclick="if(!confirm('是否刪除此筆資料？')){return false;};"><i class="fa fa-trash-o" aria-hidden="true"></i></a></th>
              </tr>
            <?php }?>
          <?php }else{ ?>
              <tr>
