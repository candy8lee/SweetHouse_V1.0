...
if(isset($_POST['MM_insert']) && $_POST['MM_insert'] == 'INSERT'){
  ...
  $sql= "INSERT INTO question_reply( title, categoryID, reply, createdDate, author)
          ...
          <form class="" method="post" action="add.php"  data-toggle="validator">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" id="reply" name="reply" data-error="請輸入內文" required></textarea>
